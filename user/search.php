...
<head>
    ...
    <title>Garbage Management System: Search Payment</title>
            ...
            <div class="container-fluid">            
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2>Search by Payment Number </h2>
                            </div>
                            ...
                            <div class="body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Enter Payment Number"></div>
